...
angular.module('risevision.apps.launcher.directives')
  .directive('prioritySupportBanner', ['localStorageService',
    'subscriptionStatusFactory', 'SUPPORT_PRODUCT_CODE', 'supportFactory',
    function (localStorageService, subscriptionStatusFactory,
      SUPPORT_PRODUCT_CODE, supportFactory) {
      return {
        restrict: 'E',
        scope: true,
        ...
        link: function ($scope) {
          ...
          if (localStorageService.get('prioritySupportBanner.show') !==
            'false') {
            subscriptionStatusFactory.checkProductCode(SUPPORT_PRODUCT_CODE)
