(function () {
  ...
  angular.module('risevision.displays.services')
    ...
    .service('display', ['$q', '$log', 'coreAPILoader', 'userState',
      'getDisplayStatus', 'screenshotRequester', 'imageBlobLoader', 'pick', 'DISPLAY_WRITABLE_FIELDS',
      'DISPLAY_SEARCH_FIELDS',
      function ($q, $log, coreAPILoader, userState, getDisplayStatus, screenshotRequester, imageBlobLoader, pick,
        ...
        var service = {
          ...
          loadScreenshot: function(displayId) {
            var url = 'https://storage.googleapis.com/risevision-display-screenshots/' + displayId + '.jpg';
